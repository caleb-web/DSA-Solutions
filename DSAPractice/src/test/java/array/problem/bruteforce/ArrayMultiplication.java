...
public class ArrayMultiplication {
	 ...
	 * 2. Initialize a value as 1 
	 * 3. Create another for loop and start with value as 1 
	 * 4. Check if inner and outer for loop values are not equal 
	 * 5. If values are not equal, multiply them till end of loop 
